...
# .........................................................
def fn_merged_view(cfg: FASTConfig, b_print_output: bool = False):
    ...
    if cfg.merged_view.s3_output:

        # Handle optional publish_sub_folder
        str_publish_sub_folder = cfg.merged_view.s3_output.publish_sub_folder.strip()
    ...
    if cfg.merged_view.local_output:
        ...
        # str_road_nav_ln_key = (
        #     f"{local_output_folder}/{model_runtime}_flood_road_nav_ln.geojson"
        # )
    ...
    if cfg.merged_view.s3_output:
        ...
        fn_write_gdf_to_s3(
            ...
            cfg.merged_view.s3_output.publish_bucket,
        ...
        # fn_write_gdf_to_s3_esrijson(gdf_s_flood_road_trim_ln, cfg.merged_view.s3_output.publish_bucket, str_s3_road_trim_ln_esri_key)
        ...
        # fn_write_gdf_to_s3_esrijson(gdf_s_flood_merge_ar, cfg.merged_view.s3_output.publish_bucket, str_s3_flood_ar_esri_key)
...
if __name__ == "__main__":
    ...
    fn_merged_view(cfg, b_print_output=not args.quiet)
